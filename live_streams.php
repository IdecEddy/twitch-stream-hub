...
class Live_streams
{
	protected static $table_name="live_streams";
	protected static $db_fields=array("id", "stream_display_name", "embed_code",'views',"pos",'time');
	public $id;
	public $stream_display_name;
	public $embed_code;
	public $views;
	public $pos;	
	public $time;
	...
	static public function find_by_thread_id($thread_id = 0)
    {
        return  self::find_by_sql("SELECT * FROM ".self::$table_name. " WHERE thread_id = {$thread_id}");
    }
	...
	static public function clear_cash()
	{
		global $database;
